					...
					<div class="sixteen columns">
						...
						<?php $header_contacts_position = ot_get_option('header_contacts_position'); ?>	
							<div class="header_contacts" <?php echo (!$header_contacts_position? " style='float: right;'": '');?>>
								<div class="wycena six columns alpha">
									<h3>ZADZWOŃ <span>i ZAPYTAJ O OFERTĘ</span></h3>
								</div>
								
								<div class="wycena six columns alpha hidden">
									<h3>Auto zastępcze za zero złotych<br><a href="tel:604545200">604 545 200</a></h3>
								</div>
